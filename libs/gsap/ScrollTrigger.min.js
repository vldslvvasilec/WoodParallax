                ...
                (se.enable = function (e) {
                    return (
                        se.isEnabled ||
                            (A(he ? be : n, "scroll", E),
                            0 <= t.indexOf("scroll") &&
                                A(he ? be : n, "scroll", Ve, s, q),
                            0 <= t.indexOf("wheel") && A(n, "wheel", We, s, q),
                            ((0 <= t.indexOf("touch") && Ce) ||
                                0 <= t.indexOf("pointer")) &&
                                (A(n, ze[0], xe, s, q),
                                A(be, ze[2], Se),
                                A(be, ze[3], Se),
        ...
        if (o) {
            ...
            (p = "scroll" + n.d2),
                X(
                    ...
                    (_ && 20 < S) ||
                        (!_ &&
                            (u ? Math.max(rt[p], tt[p]) : o.parentNode[p]) <=
                                S + 1)
                ),
                u &&
                    ((l = Ct(a)),
        ...
        Lt = function _setState(e) {
            if (e) {
                var t,
                    ...
                    o = 0;
                for (
                    (e.t._gsap || Ge.core.getCache(e.t)).uncache = 1;
                    o < i;
                    o += 2
                )
                    (r = e[o + 1]),
            ...
            ((ScrollTrigger.prototype.init = function init(_, T) {
                if (
                    ...
                    var k,
                        ...
                        o,
                        Q = (_ = eb(
                            Ia(_) || Ka(_) || _.nodeType ? { trigger: _ } : _,
                            Ot
                        )).onUpdate,
                        Z = _.toggleClass,
                        a = _.id,
                        ...
                        we = ve
                            ? 0
                            : parseFloat(cb(be)["border" + ge.p2 + Mt]) || 0,
                        Se = this,
                        _e =
                            _.onRefreshInit &&
                            function () {
                    ...
                    if (
                        ...
                        (C = this.markerStart =
                            tb("start", a, f, ge, e, t, 0, fe)),
                            (O = this.markerEnd =
                                tb("end", a, f, ge, e, t, 0, fe)),
                ...
                var n = e.getBoundingClientRect(),
                    ...
                    o =
                        null == t
                            ...
                            : parseFloat(t) || 0;
                return r
                    ? (n.left + o) / qe.innerWidth
                    : (n.top + o) / qe.innerHeight;
            }),
    ...
    function lc(e) {
        ...
        return (
            ...
            (e.onPress = function () {
                var e = m;
                (m = za(
                    ((qe.visualViewport && qe.visualViewport.scale) || 1) / y
                )),
                    a.pause(),
                    e !== m && ec(d, 1.01 < m || (!f && "x")),
                    (c = v()),
